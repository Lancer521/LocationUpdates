...
/**
 * @author Lancer521 on 12/15/2015.
 */
public class LoadSchedule {

  private static final String LOG_TAG = LoadSchedule.class.getSimpleName();

  public LoadSchedule() {
  }

  private static Calendar calendar = Calendar.getInstance();
  private static int currYear = calendar.get(Calendar.YEAR);
  private static int currMonth = calendar.get(Calendar.MONTH);
  private static int currDay = calendar.get(Calendar.DAY_OF_MONTH);
